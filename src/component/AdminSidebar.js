...
function AdminSidebar() {
  return (
    <div className="fixed">
      <div className="w-64 h-[100vh] bg-gray-50 rounded-r bg-gray-800">
        <div className="overflow-y-auto py-4 px-3 ">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a
                href="/administration-transaction"
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  aria-hidden="true"
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Laporan Penjualan</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Back Home</span>
              </a>
            </li>
          </ul>
        </div>
